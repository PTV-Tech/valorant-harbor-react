...
const Profile = () => {
  ...
  return (
    <>
      <section className="section bg-profile" style={{}}>
          ...
          <div className="description-skill">
            <Tab.Content>
              ...
              <Tab.Pane eventKey="second">
                <p>Q - Thủy Khiên</p>
                <p>TRANG BỊ 1 quả cầu thủy khiên. Nhấn BẮN để ném. Nhấn CHẾ ĐỘ PHỤ để ném tầm thấp. Khi chạm đất, tạo ra một lớp khiên nước có thể bị phá huỷ và có khả năng chặn đường đạn.</p>
              </Tab.Pane>
